...
I ended up making the game quirte difficult which underlines the real frustration in tennis. I had realised that I had not implemented any classes yet so that is what I will be getting to. By converting the previous logic used for the ball into the current one.
